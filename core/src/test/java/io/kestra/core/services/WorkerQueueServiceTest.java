...
/**
 * Exercises the SystemTask short-circuit enforced by {@link WorkerQueueService.Default}.
 * The invariant lives on the OSS class — any subclass (including the EE resolver)
 * inherits it through the {@code final resolveWorkerQueueForJob} method.
 */
