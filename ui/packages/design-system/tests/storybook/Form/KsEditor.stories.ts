...
const meta: Meta<typeof KsEditor> = {
    ...
    argTypes: {
        ...
        pebble: {control: "boolean"},
        duplicateTaskIdMarkers: {control: "boolean"},
    },
    parameters: {
...
export const Diff: Story = {
    render: () => ({
        ...
        template: "<div style=\"padding:24px;height:420px\"><ks-editor v-model=\"modified\" :original=\"original\" lang=\"yaml\" :diffSideBySide=\"true\" /></div>",
    }),
    parameters: {docs: {description: {story: "Passing `original` mounts the diff editor. Toggle `diffSideBySide` for inline vs side-by-side."}}},
}
